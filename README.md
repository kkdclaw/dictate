...
- **Только мой голос** — голосовой отпечаток (ECAPA-эмбеддинги): речь, не
  похожая на записанный отпечаток (ТВ, коллеги), не транскрибируется. Сначала
  «Записать отпечаток голоса (5 с)»;
